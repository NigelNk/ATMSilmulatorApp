...
public class DepositController {
    ...
    public void enterBtn(ActionEvent actionEvent) {
        ...
        if (amt < 0) {
            ...
            TranscriptController.Transaction l = new TranscriptController.Transaction(LocalDateTime.now(), "Deposit", 0.0, amt, account.getBalance());
            TranscriptController.transactions.add(l);

            alert.setContentText("You have deposited " + amt + "Mk to your account");
            amountField.setText("");
            alert.showAndWait();
